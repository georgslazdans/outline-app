...
/**
 * Changes:
 * Use cache first instead of StaleWhileRevalidate. Since most of the content is hashed and should'nt use network
 * 
 * Modified default caching, based on recommended list of caching strategies for applications
 * built with Next.js.
 */
export const outlineAppCache: RuntimeCaching[] =
